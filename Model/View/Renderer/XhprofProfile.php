...
class XhprofProfile
{
     ...
     *
     * @return XhprofProfile a new instance with exclusive data set
     */
     ...
     */
    public function sort($dimension, $data = null)
    {
        if (!$data) {
     ...
     *
     * @param XhprofProfile $head The other run to compare with
